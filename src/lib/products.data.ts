...
//
// รูปภาพถูกดาวน์โหลดมาเก็บไว้ใน public/images/products/ แล้ว ไม่ได้เรียกจาก CDN ภายนอก
// เพราะ CDN ของร้านเดิมกัน hotlink ทำให้รูปไม่ขึ้นเมื่อเรียกจากโดเมนอื่น
// ถ้าเพิ่มสินค้าที่รูปยังชี้ไป URL ภายนอก ให้รัน: node scripts/download-images.mjs
//
// แก้ไฟล์นี้แล้วต้องบวก CATALOG_VERSION ใน src/store/AppStore.tsx ด้วย
// ไม่งั้นคนที่เคยเข้าเว็บมาก่อนจะเห็นข้อมูลชุดเก่าค้างอยู่
